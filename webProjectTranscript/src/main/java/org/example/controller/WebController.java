...
//            d6 =  3 + random.nextDouble();
    ...
    public ModelAndView handleFileUpload(@RequestParam("file") MultipartFile file) {
        ...
        if(linesList.size() > 10) {
             ...
             CyberSecurityDegreeeSource d1 = assignDefaultCourses(coursesList.get(0),coursesList.get(1),coursesList.get(2),coursesList.get(3),coursesList.get(4));
    ...
    public ModelAndView showCourseTable(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("cs_c1","cs_c2","cs_pre",null,null);
    ...
    public ModelAndView showCourseTabledatascience(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("ds_c1","ds_c2","ds_pre","ds_c3","ds_c4");
    ...
    public ModelAndView showCourseTableintsystem(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("is_c1","is_c2","is_pre","is_c3","is_c4");
    ...
    public ModelAndView showCourseTableintcomputing(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("ic_c1","ic_c2","ic_pre",null,null);
    ...
    public ModelAndView showCourseTablenandt(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("nandt_c1","nandt_c2","nandt_pre",null,null);
    ...
    public ModelAndView showCourseTabletcscience(Model model) {
        ...
        CyberSecurityDegreeeSource degree = null;
        degree = assignDefaultCourses("tcs_c1","tcs_c2","tcs_pre","tcs_c3","tcs_c4");
    ...
    public CyberSecurityDegreeeSource assignDefaultCourses(String c1,String c2,String pre,String c3,String c4){
        ...
        List<Course> coursesc3 = map.getOrDefault(c3,empty);
        List<Course> precoursesc4 = map.getOrDefault(c4,empty);
        ...
        degree.setTwocourses(coursesc3);
        degree.setAppcourses(precoursesc4);
        return degree;
    }
    ...
    public CyberSecurityDegreeeSource processPDF(CyberSecurityDegreeeSource degree,List<String> pdfdata) {
        ...
        Map<String,Course> mapCourc3 = new HashMap<>();
        Map<String,Course> mapPrec4 = new HashMap<>();
        ...
        for(Course cc : coursList) {
            ...
            if(!degree.getTwocourses().isEmpty() && degree.getTwocourses().size() > 1) {
                for (Course coreList : degree.getTwocourses()) {
                    if(coreList.getNumber() != null && coreList.getNumber().length() > 3) {
                        ...
                        if (num.equalsIgnoreCase(cc.getNumber().split("\\s+")[1])) {
                            //System.out.println("courses "+cc.getNumber()+" "+cc.getTitle()+" "+cc.getGrade());
                            List<Course> b = courses;
                            mapCourc3.put(cc.getNumber().trim(),cc);
                            checkflag = true;
                        }
                    }
                }
            ...
            if(!degree.getAppcourses().isEmpty() && degree.getAppcourses().size() > 1) {
                for (Course coreList : degree.getAppcourses()) {
                    if(coreList.getNumber() != null && coreList.getNumber().length() > 3) {
                        ...
                        if (num.equalsIgnoreCase(cc.getNumber().split("\\s+")[1])) {
                            //System.out.println("courses "+cc.getNumber()+" "+cc.getTitle()+" "+cc.getGrade());
                            List<Course> b = courses;
                            mapPrec4.put(cc.getNumber().trim(),cc);
                            checkflag = true;
                        }
                    }
                }
        ...
        twocourses.addAll(mapCourc3.values());
        appcourses.addAll(mapPrec4.values());
        ...
        twocourses.addAll(notEqualCources(twocourses,degree.getTwocourses()));
        appcourses.addAll(notEqualCources(appcourses,degree.getAppcourses()));
    ...
    public ModelAndView getData(@ModelAttribute Data data) {
        ...
        if(this.cyberdegree == null) {
            ...
            this.plan = p;
            List<String> coursesList = getCourseOnPlan(p);
            degree = assignDefaultCourses(coursesList.get(0),coursesList.get(1),coursesList.get(2),coursesList.get(3),coursesList.get(4));
